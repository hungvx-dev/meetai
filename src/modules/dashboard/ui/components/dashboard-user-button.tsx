...
export function DashboardUserButton() {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger className="border-border/10 bg-primary/10 hover:bg-primary/20 flex w-full cursor-pointer items-center gap-2 overflow-hidden rounded-lg p-3">
        {data.user.image ? (
          <Avatar>
